...
public class GetSongID extends BreadthCrawler {
        File downloadDir = new File("song");
        ...
        public void visit(Page page, CrawlDatums next) {
                ...
                if (Pattern.matches(song_regex, page.getUrl())) {
                        ...
                        //                                e.printStackTrace();
                        //                        }
                        mp3Url = "http://music.163.com/song/media/outer/url?id=" + songId + ".mp3";
        ...
        public static void main(String[] args) throws Exception {
                ...
                crawler.addSeed("http://music.163.com/#/my/m/music/playlist?id=110259166", true);
                // 设置采集规则为所有类型的网页
                //                crawler.addRegex("http://music.163.com/.*");
                crawler.addRegex("http://music.163.com/#/my/m/music/playlist?id=110259166");
                // 设置爬取URL数量的上限
